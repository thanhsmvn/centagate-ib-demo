...
public class CROTPTrans {
    ...
    public HashMap<String , String> Authenticate(String username, String otp, String challenge, String authToken, String ipAddress, String userAgent, String browserFp) 
    {
        ...
        map.put ( "details" , "Success with CROTP TAC" ) ;  
        ...
        WebResource service = client.resource ( APIController.getBaseURI()+  "/trans/authorise/"+username  );
